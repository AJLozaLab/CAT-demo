...
/** Main-path step where the branch button is shown (the fork token where the word changes). */
function branchSwitchStepIndex(_mainSteps, branchIndex) {
